  ...
  return (
    ...
    >
      <motion.button 
        ...
        className={`w-10 h-10 lg:w-16 lg:h-16 rounded-xl lg:rounded-2xl flex items-center justify-center shadow-xl transition-all border ${isMeasuring ? 'bg-emerald-600 text-white border-transparent shadow-emerald-500/20' : 'glass border-white/10 text-emerald-500'}`}
      >
      ...
      <motion.button 
        ...
        className={`w-10 h-10 lg:w-16 lg:h-16 rounded-xl lg:rounded-2xl flex items-center justify-center shadow-xl transition-all border ${is3D ? 'bg-blue-600 text-white border-transparent shadow-blue-500/20' : 'glass border-white/10 text-slate-400'}`}
      >
      ...
      <motion.div 
        ...
        onClick={onRecenter}
        className="w-10 h-10 lg:w-16 lg:h-16 rounded-xl lg:rounded-2xl glass flex items-center justify-center shadow-xl cursor-pointer border border-white/10"
      >
      ...
      <motion.button 
        ...
        className="w-10 h-10 lg:w-16 lg:h-16 rounded-xl lg:rounded-2xl glass border border-white/10 flex items-center justify-center shadow-xl text-blue-500"
      >
